...
public class MessageController {
    ...
    public static ClientResponse sendOwnerMessage(Item itemBorrowed, Transaction transaction, MessageRepo messages, UserRepo users) {
        ...
        String body = getHtmlMessageBody(ACCEPT_URL, DECLINE_URL);
    ...
    public static void sendRenterMessageAccept(Transaction transaction) {

    }

    public static String getHtmlMessageBody(String ACCEPT_URL, String DECLINE_URL){
